...
import cn.clickwise.adapters.FileListAdapter;
import cn.clickwise.adapters.RemoteFileListAdapter;
import cn.clickwise.utils.sshutils.SessionController;
import cn.clickwise.utils.sshutils.TaskCallbackHandler;
...
public class FileListActivity extends Activity implements OnItemClickListener, OnClickListener, OnDragListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        mSessionController.connect(false);
    ...
    /**
     * Shows the remote files on the lv.
     */
